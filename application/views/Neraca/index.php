                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Rp. <?= number_format($piutang_informent, 0, ',', ',') ?></td>
                                        <td>Rp. <?= number_format($piutang_usaha, 0, ',', ',') ?></td>
                                        <td>Rp. <?= number_format($modal, 0, ',', ',') ?></td>
                                    </tr>
                                </tbody>
                                <?php $total_asetlancar = $kas + $piutang_gaji + $piutang_usaha + $modal ?>
                                <tfoot>
                                    <tr>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Rp. <?= number_format($kas, 0, ',', ',') ?></td>
                                        <td>Rp. <?= number_format($piutang_gaji, 0, ',', ',') ?></td>
                                        <td>Rp. <?= number_format($piutang_usaha, 0, ',', ',') ?></td>
                                        <td>Rp. <?= number_format($modal, 0, ',', ',') ?></td>
                                        <td>Rp. <?= number_format($modal, 0, ',', ',') ?></td>
                                    </tr>
                                </tbody>
                                <?php $total_beban = $kas + $piutang_gaji + $piutang_usaha + $modal ?>
                                <tfoot>
                                    <tr>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php $total = $kas + $piutang_gaji + $piutang_usaha ?>
                                <tfoot>
                                    <tr>
